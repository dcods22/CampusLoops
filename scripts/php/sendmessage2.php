<?php
	...
	$messageController = new SendMessageController2('messages');
	...
	if(!empty($messageText)){
		$receiverID = $messageController->getUserID($receiver);
		...
		header('Location: http://campusloops.com/chat.php?id=' . $messageID);
	}else{
		header('Location: http://campusloops.com/chat.php?id=' . $messageID);
	}
?>